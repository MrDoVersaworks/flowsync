...
import { Calendar, Hash, AlignLeft, Sparkles, Trash2 } from 'lucide-react';
      ...
      >
        ...
        {!isOverlay && (
          <button
            ...
            className="absolute -top-2 -right-2 p-2 bg-red-500 text-foreground rounded-full opacity-0 group-hover:opacity-100 transition-smooth hover:scale-110 shadow-lg z-20"
            title="Purge Task"
          >
